...
public class WXPayConstants {
	...
	public static final String SENDING = "SENDING"; //发放中 
	
	public static final String SENT = "SENT"; // 已发放待领取
	
	public static final String FAILED = "FAILED"; // 发放失败
	
	public static final String RECEIVED = "RECEIVED"; //已领取 
	
	public static final String RFUND_ING = "RFUND_ING "; //退款中
