...
public class SmsUtils {
    ...
    public static SendSmsResponse sendSms(String phoneNumber,String smsCode,String templateCode) throws ClientException {
        ...
        //可选:outId为提供给业务方扩展字段,最终在短信回执消息中将此值带回给调用者
        request.setOutId("1100000" + RandomStringUtils.randomNumeric(21));
	...
	public static void sendSms(String phone, String errorMsg) throws ClientException {
		 //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
        ...
        request.setSignName("圈兔科技");
        //必填:短信模板-可在短信控制台中找到
    	request.setTemplateCode("SMS_165419028");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{ \"name\":\""+errorMsg+"\"}");
