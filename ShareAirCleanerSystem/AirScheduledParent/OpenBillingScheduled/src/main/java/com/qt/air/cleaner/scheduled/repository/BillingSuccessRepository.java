...
public interface BillingSuccessRepository extends JpaRepository<BillingSuccess, String> {
	...
	BillingSuccess findByTransactionIdAndBillingIdAndDeviceIdAndTotalFeeAndRemoved(String transactionId,String billingId,String deviceId,Float totalFee,Boolean removed);
}
