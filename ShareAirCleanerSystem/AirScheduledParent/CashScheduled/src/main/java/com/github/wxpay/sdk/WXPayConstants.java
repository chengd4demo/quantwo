...
public class WXPayConstants {
	...
	public static final String SENT = "已发放待领取";
	
	public static final String FAILED = "发放失败";
	
	public static final String RECEIVED = "已领取 ";
	
	public static final String RFUND_ING = "退款中 ";
